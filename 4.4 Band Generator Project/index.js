...
app.post("/submit", (req, res) => {
    ...
    let adjVal = Math.floor(Math.random() * adj.length);
    let nounVal = Math.floor(Math.random() * noun.length);
    let adjName = adj[adjVal];
    let nounName = noun[nounVal];

    let finalString = adjName + ' ' +
        nounName;
    console.log(finalString);

    res.render("index.ejs", { title: finalString });
});
